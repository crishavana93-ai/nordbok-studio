...
<div style="max-width:560px;margin:0 auto;background:#fff;border:1px solid #e7e7e0;border-radius:14px;overflow:hidden">
  ...
  return { subject, html, summary: { sumPaid, sumOpen, sumExpenses, tripDed, profit, tax: tax.total_skatt, overdue: overdue.length, due14: due14.length, reviewQ: reviewQ.length } };
}
