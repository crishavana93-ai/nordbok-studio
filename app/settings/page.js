      ...
      <form onSubmit={save}>
        ...
        <div className="card" style={{ marginBottom: 14 }}>
          ...
          <div className="grid-3">
            ...
            <div className="field"><label className="label">Blindkopia av varje faktura</label><input className="input" type="email" value={s.invoice_bcc || ""} onChange={(e) => setS({ ...s, invoice_bcc: e.target.value })} placeholder="hello@turquinostudios.com" /><div className="muted" style={{ fontSize: 12, marginTop: 4 }}>Utskicken går via e-postleverantörens servrar, inte via ditt mailprogram — därför syns de aldrig i mappen Skickat. En blindkopia lägger en riktig kopia i din inkorg.</div></div>
